...
#
OP_FOR_EVAL = get_op_from_new_graph(sess =sess, op = OP_FOR_EVAL, graph_dup_cnt= dup_cnt, dummy_graph_dup_cnt = dummy_graph_dup_cnt)
INPUT_x = get_op_from_new_graph(sess =sess, op = INPUT_x, graph_dup_cnt= dup_cnt, dummy_graph_dup_cnt = dummy_graph_dup_cnt)
INPUT_keep_prob = get_op_from_new_graph(sess =sess, op = INPUT_keep_prob, graph_dup_cnt= dup_cnt, dummy_graph_dup_cnt = dummy_graph_dup_cnt)
