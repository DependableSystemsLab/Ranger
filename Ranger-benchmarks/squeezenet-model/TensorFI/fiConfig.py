...
class FIConfig(object):
	...
	faultTypeMap = { 
		...
		# same for doing monotonic bit flip on tensor and scalar values
		FaultTypes.BINA.value : (binaryBitFlip, binaryBitFlip),
		FaultTypes.SEQU.value : (sequentialBitFlip, sequentialBitFlip)
	}
	...
	def __init__(self,fiParams):
		...
		self.opInstance = { }
		# Configure the amount of total instance of the algorithm
