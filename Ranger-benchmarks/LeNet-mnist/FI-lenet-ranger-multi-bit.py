...
import TensorFI_ranger_multiBit as ti
...
#        print('Minibatch error: %.1f%%' % error_rate(predictions, batch_labels))
    ...
    eachRes = open("lenet-eachFI-ranger-multiBit.csv", "a")
    resFile = open("lenet-randomFI-ranger-multiBit.csv", "a")
    ...
    print("SDC rate for each input is saved at: ", resFile)
